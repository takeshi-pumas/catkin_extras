...
def readSensor(data):
    ...
    try:
        ...
        if (xcl!=0 and ycl!=0):
            ...
            print (f'x map y map {x_map,y_map}')
            print ('x,y,th Odom No map',x,y,th)
            vel=0.07
            if (euclD < 1.5) :
                speed.linear.x=0
                speed.linear.y=0
        ...
        print("An error occurred while looking up the transform: wait for buffer to fill", str(e))
