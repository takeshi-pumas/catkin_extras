...
#include "moveit_services/moveitPosition.h"
...
private:
    ...
    static ros::ServiceClient cltmoveitPosition;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /////////////////// moveit services  /////////////////////////
    //////////////////////////////////////////////////////////////
    static bool moveitGoalPosition(std::string move_group, geometry_msgs::Pose pose);
    static bool moveitGoalPosition(std::string move_group, float x, float y, float z, float roll, float pitch, float  yaw);
};
