...
int main(int argc, char** argv)
{
    ...
    if(ros::param::has("~control_alpha"))   ros::param::get("~control_alpha", control_alpha);
    if(ros::param::has("~control_beta"))    ros::param::get("~control_beta", control_beta);
    if(ros::param::has("~max_linear"))      ros::param::get("~max_linear", max_linear);
    if(ros::param::has("~max_angular"))     ros::param::get("~max_angular", max_angular);
    if(ros::param::has("~dist_to_human"))   ros::param::get("~dist_to_human", dist_to_human);
    if(ros::param::has("~move_backwards"))  ros::param::get("~move_backwards", move_backwards);
    if(ros::param::has("~move_head"))       ros::param::get("~move_head", move_head);
    if(ros::param::has("~pot_fields"))      ros::param::get("~pot_fields", pot_fields);
    if(ros::param::has("~legs_pose_topic")) ros::param::get("~legs_pose_topic", legs_pose_topic);
