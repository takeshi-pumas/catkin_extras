...
robot_controls_layout = [
    [sg.Text("")],
    [sg.Button('', size=(1, 1), key='-TURN_L-',     button_color='white', image_filename=f'{assets_dir}arrow_l.png'), 
     sg.RealtimeButton('', size=(1, 1), key='-FORWARD-',    button_color='white', image_filename=f'{assets_dir}arrow_up.png'), 
     sg.Button('', size=(1, 1), key='-TURN_R-',     button_color='white', image_filename=f'{assets_dir}arrow_r.png')],
    [sg.Button('', size=(1, 1), key='-LEFT-',       button_color='white', image_filename=f'{assets_dir}arrow_left.png'), 
     sg.Button('', size=(1, 1), button_color='white'), 
     sg.Button('', size=(1, 1), key='-RIGHT-',      button_color='white', image_filename=f'{assets_dir}arrow_right.png')],
    [sg.Text('', size=(1, 1)), 
     sg.Button('', size=(1, 1), key='-BACKWARD-',   button_color='white', image_filename=f'{assets_dir}arrow_down.png'),
     sg.Text('', size=(1, 1))],
